user_1 = ["Стефан", "Сальваторе", "Эдальго 1", "Комсомольская", "89993332244", '31.03.2024', "Я теперь добрый"]
user_2 = ["Дэймон", "Сальваторе", "Цимлянская 2", "Люблино", "89991115566",'01.04.2024', "А я всегда не очень"]
